...
public class Buch extends Artikel {
	 ...
	 * 
	 * @param autor Beschreibt den Autor des Buches
	 */
	private String autor;
	private String TYP = "Buch";
	
	//-----
	
	/**
	 * Angepaster Konstruktor der Klasse Buch.
	 ...
	 * @param autor Beschreibt den Autor des Buches
	 */
	public Buch(Lager lagerOrt, String hersteller, String titel, String artikelnummer, int menge, Double preis, String autor) {
	...
	public void lagerInventur() {
		this.lagerOrt.setBestandBuch(artikelMenge);
